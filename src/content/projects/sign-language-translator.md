...
description: "Real-time Indian Sign Language to text system using MediaPipe landmarks with LSTM vs DTW comparison, plus text-to-sign pipeline via NLP gloss conversion."
date: 2025-05-01
tags: ["Python", "MediaPipe", "LSTM", "DTW", "NLP"]
type: "research"
featured: true
featuredOrder: 2
excerpt: "Final Year Project - real-time ISL-to-text using MediaPipe landmarks, achieving 94.32% accuracy on dynamic gestures with DTW."
---
...
![UI workflow](/images/projects/bdslt/ui-workflow.png)
...
![Sign-to-text workflow](/images/projects/bdslt/stt-workflow.png)
...
![Text-to-sign workflow](/images/projects/bdslt/tts_workflow.png)
...
![DTW predictions](/images/projects/bdslt/predictions.png)

Text-to-sign UI showing text → gloss conversion, dictionary mapping, and merged video playback:

![Text-to-sign UI](/images/projects/bdslt/tts_ui.png)
